 ...
 */
void slist_add_front(struct slist *l, char *str);
...
/**
 * Determinet whether a given string is already stored in the list.
 *
 * @param l pointer to the list (non-NULL)
 * @param str pointer to the string to search in l
 */
int slist_find(struct slist *l, char *str);
#endif /* SLIST_H_ */
